function simulate_square(Gz, Gcz, T, label, OutSat)
    ...
    subplot(2,1,1);
    plot(t, ref, 'k--', t, y, 'b', 'LineWidth', 1.5);
    grid on; title(['Resposta à Onda Quadrada - ', label]);
    legend('Referência', 'Saída y(t)');

    subplot(2,1,2);
    plot(t, u_ideal, 'r', 'LineWidth', 1.2, t, u_sat, 'g', 'LineWidth', 1.2);
