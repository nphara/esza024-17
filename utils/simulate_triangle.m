function [t_sat, u_max] = simulate_triangle(Gz, Gcz, T, label, OutSat, save_path)
    ...
    grid on;
    title({['Resposta à Onda Triangular - ', label], sprintf('T_s = %.4f s', T)});
    ...
    ax2 = subplot(2,1,2);
    stairs(t, u_ideal, 'b', 'LineWidth', 1.2); hold on;
    stairs(t, u_sat, 'm', 'LineWidth', 1.2);
